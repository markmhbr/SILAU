        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Informasi pelanggan dan riwayat transaksi
                </p>
            </div>
        ...
        <div
            ...
            <table class="w-full text-left border-collapse">
                <tbody class="divide-y divide-slate-50 dark:divide-slate-800">
                    ...
                    <tr>
                        <td class="px-6 py-5 w-64 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">
                            Pelanggan
                        </td>
                        <td class="px-6 py-5">
                            <div class="flex items-center gap-3">
                                @if (!empty($pelanggan->foto_url))
                                    <img src="{{ $pelanggan->foto_url }}"
        ...
        <div
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50 dark:divide-slate-800">
                        @forelse($pelanggan->transaksi as $t)
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition">
                                ...
                                <td class="px-6 py-5">
                                    <span class="px-3 py-1 rounded-lg text-[10px] font-black bg-slate-100 text-slate-600">
                                        {{ $t->status }}
                                    </span>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-20 text-center text-slate-400 font-bold">
                                    Belum ada transaksi
                                </td>
                            </tr>
                        @endforelse
