    ...
    <div class="max-w-5xl mx-auto space-y-8 animate-fadeIn">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola informasi pribadi dan data kepegawaian
                    Anda.</p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="p-8 md:p-12 relative z-10">
                <form action="{{ route('karyawan.profil.update', $karyawan->id) }}" method="POST"
                    ...
                    <div class="flex flex-col lg:flex-row gap-16">
                        <div class="w-full lg:w-1/3 flex flex-col items-center">
                            ...
                            <div class="mt-8 text-center">
                                <h3 class="text-xl font-black text-slate-800 dark:text-white">{{ $karyawan->user->name }}
                                </h3>
                                <span
                            ...
                            <div
                                ...
                                <p class="text-xs font-bold text-slate-600 dark:text-slate-300 mb-4">Tunjukkan QR ini ke
                                    Admin<br>saat masuk/pulang kerja.</p>

                                <a href="{{ route('karyawan.profil.print-card') }}" target="_blank"
                                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs rounded-xl transition shadow-lg shadow-emerald-500/30 hover:scale-105 active:scale-95">
                        ...
                        <div class="w-full lg:w-2/3 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    <label
                                        class="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Jabatan
                                        / Posisi</label>
                                    <div class="group relative">
                                        ...
                                        <input type="text"
                                            ...
                                            class="w-full pl-12 pr-6 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-800/80 text-slate-500 cursor-not-allowed font-bold"
                                            title="Jabatan tidak dapat diubah sendiri">
                                    </div>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="group relative">
                                        ...
                                        <input type="tel" name="no_hp" value="{{ old('no_hp', $karyawan->no_hp) }}"
                                            class="w-full pl-12 pr-6 py-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/50 focus:bg-white dark:focus:bg-slate-800 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all font-semibold font-mono"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="group relative">
                                        <div class="absolute bottom-4 right-4 z-10">
                                            <a href="{{ route('karyawan.alamat') }}"
                                                class="flex items-center gap-2 px-3 py-1.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-[10px] font-black transition-all shadow-lg hover:scale-105 active:scale-95">
                                        ...
                                        <div
                                            class="absolute top-4 left-4 text-slate-400 group-focus-within:text-emerald-500 transition-colors">
                                        ...
                                        <textarea readonly
                                            ...
                                            rows="4" placeholder="Alamat belum diatur...">{{ $karyawan->alamat_gabungan }}</textarea>
                                    </div>
                                    <p class="mt-2 ml-1 text-[10px] text-slate-400 font-bold italic">* Alamat ini digunakan
                                        sebagai acuan titik koordinat penugasan.</p>
                                </div>
                            </div>

                            <div class="pt-6">
                                <button type="submit"
                                    class="group w-full md:w-auto bg-slate-900 dark:bg-emerald-500 hover:bg-black dark:hover:bg-emerald-600 text-white px-10 py-4 rounded-2xl font-black text-sm transition-all hover:shadow-2xl hover:shadow-emerald-500/20 active:scale-95 flex items-center justify-center gap-3">
